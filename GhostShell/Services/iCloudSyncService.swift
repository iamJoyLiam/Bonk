...
final class iCloudSyncService {
    ...
    private enum Keys {
        static let hosts = "ghostshell_hosts"
        static let preferences = "ghostshell_preferences"
        static let lastSynced = "ghostshell_last_synced"
    }

    init() {
        self.isEnabled = UserDefaults.standard.bool(forKey: "sync_icloud")
