...
enum L {
    static var lang: String { I18n.shared.lang }

    static func t(_ key: LKey) -> String { I18n.shared.t(key) }
    ...
    static var availableLanguages: [String] { I18n.shared.availableLanguages }
    static func displayName(for code: String) -> String { I18n.shared.displayName(for: code) }
}
