...
enum LKey: String, CaseIterable {
    ...
    case enableGhostSuggestions = "enable_ghost_suggestions"
    ...
    case decisionEngineChoice = "decision_engine_choice"
    case decisionStrictness = "decision_strictness"
    case decisionStrictnessOpen = "decision_strictness_open"
    case decisionStrictnessBalanced = "decision_strictness_balanced"
    case decisionStrictnessCautious = "decision_strictness_cautious"
    case decisionStrictnessStrict = "decision_strictness_strict"
    case routingCost = "routing_cost"
    case routingCostAuto = "routing_cost_auto"
    case routingCostFreeOnly = "routing_cost_free_only"
    case jevAPIKey = "jev_api_key"
    case jevKeyRequired = "jev_key_required"
    case jevEndpoint = "jev_endpoint"
    case jevModel = "jev_model"
    case layaEndpoint = "laya_endpoint"
    case layaCheckpoint = "laya_checkpoint"
    case layaCheckpointAuto = "laya_checkpoint_auto"
    case testDecisionEngine = "test_decision_engine"
    case decisionEngineOK = "decision_engine_ok"
    case decisionEngineFailed = "decision_engine_failed"
    case layaBridgeHint = "laya_bridge_hint"
    // AI — Context
    case context
    ...
    // Export hosts
    case exportHostsTitle = "export_hosts_title"
    case exportHostsDesc = "export_hosts_desc"
    case exportIncludeSecrets = "export_include_secrets"
    case exportToFile = "export_to_file"
    case importSection = "import_section"
    case quickImport = "quick_import"

    // AI agent access mode
    case aiAccessMode = "ai_access_mode"
    case aiMaxRounds = "ai_max_rounds"
    case aiRoundsCount = "ai_rounds_count"
    case aiModeFullDesc = "ai_mode_full_desc"
    case aiModeSupervisedDesc = "ai_mode_supervised_desc"
    case aiModeReadonlyDesc = "ai_mode_readonly_desc"
    case aiEffectivePrefix = "ai_effective_prefix"
    case aiAgentHelp = "ai_agent_help"
    case aiAccessModeHelp = "ai_access_mode_help"
    case accessFull = "access_full"
    case accessSupervised = "access_supervised"
    case accessReadonly = "access_readonly"
    case accessFullShort = "access_full_short"
    case accessSupervisedShort = "access_supervised_short"
    case accessReadonlyShort = "access_readonly_short"
    case aiInvalidEndpoint = "ai_invalid_endpoint"
    case aiAuthFailed = "ai_auth_failed"
    case aiConnectionFailed = "ai_connection_failed"

    // Log coloring
    case logColors = "log_colors"
    case logDefaultBadge = "log_default_badge"
    case logNewProfile = "log_new_profile"
    case logRulesCount = "log_rules_count"
    case logNewProfileName = "log_new_profile_name"
    case logRename = "log_rename"
    case logNamePlaceholder = "log_name_placeholder"
    ...
    case logDeletePatternButton = "log_delete_pattern_button"
    case logDeletePatternMsg = "log_delete_pattern_msg"
    case logEmptyTitle = "log_empty_title"
    case logEmptyDesc = "log_empty_desc"
    case logHelp = "log_help"
    case logBasic = "log_basic"
    case logPreset = "log_preset"
    case logRegex = "log_regex"
    case logColorSection = "log_color_section"
    case logCustomColor = "log_custom_color"
    case logEnterPattern = "log_enter_pattern"
    case logInvalidRegex = "log_invalid_regex"
    case logNoMatch = "log_no_match"
    case logMatchCount = "log_match_count"
    case logPriority = "log_priority"
    case logPresetCustom = "log_preset_custom"
    case logPresetTimestamp = "log_preset_timestamp"
    case logSaveError = "log_save_error"

    // Sidebar (hosts)
    case sbSkDetected = "sb_sk_detected"
    case sbSkHelp = "sb_sk_help"
    case sbSkProvider = "sb_sk_provider"
    case sbLogSection = "sb_log_section"
    case sbLogProfile = "sb_log_profile"
    case sbFollowDefault = "sb_follow_default"
    case sbBackendCompat = "sb_backend_compat"
    case sbImportHint = "sb_import_hint"
    case sbImportError = "sb_import_error"

    // Terminal state
    case inspPolicyNoExpire = "insp_policy_no_expire"
    case termFallbackCompat = "term_fallback_compat"
    case termFallbackEngine = "term_fallback_engine"

    // AI chat
    case aiSwitchMode = "ai_switch_mode"
    case aiSendHelp = "ai_send_help"
    case slashClearDesc = "slash_clear_desc"
    case slashFixDesc = "slash_fix_desc"
    case slashExplainDesc = "slash_explain_desc"
    case slashCompactDesc = "slash_compact_desc"
    case slashHelpDesc = "slash_help_desc"
    case mentionTerminalDesc = "mention_terminal_desc"
    case mentionHistoryDesc = "mention_history_desc"
    case mentionHostDesc = "mention_host_desc"
    case mentionSelectionDesc = "mention_selection_desc"
    case slashHeader = "slash_header"
    case mentionHeader = "mention_header"
    case popupHint = "popup_hint"
    case aiMentionSummary = "ai_mention_summary"
    case aiConnectFailed = "ai_connect_failed"
    case inlineSummaryTranslated = "inline_summary_translated"
    case inlineSummaryPredicted = "inline_summary_predicted"

    // Agent runtime (chat/system messages)
    case agMaxRoundsReached = "ag_max_rounds_reached"
    case agExecutionCancelled = "ag_execution_cancelled"
    case agNoAnomalies = "ag_no_anomalies"
    case agPlanStopped = "ag_plan_stopped"
    case agRepeatHint = "ag_repeat_hint"
    case agReadonlyBlocked = "ag_readonly_blocked"
    case agLoopDuplicate = "ag_loop_duplicate"
    case agLoopStalled = "ag_loop_stalled"
    case mirrorLinesOutput = "mirror_lines_output"
    case mirrorLinesOmitted = "mirror_lines_omitted"
    case mirrorRunning = "mirror_running"
    case mirrorSuccess = "mirror_success"
    case mirrorFailed = "mirror_failed"
    case mirrorBlocked = "mirror_blocked"
    case mirrorSkipped = "mirror_skipped"

    // Team
    case tmNotConnectedDesc = "tm_not_connected_desc"
    case tmShareEnded = "tm_share_ended"
    case tmShareEndedDefault = "tm_share_ended_default"
    case tmRequestSent = "tm_request_sent"
    case tmNoSharedTerminal = "tm_no_shared_terminal"
    case tmUnauthorized = "tm_unauthorized"
    case tmPeopleCount = "tm_people_count"
    case tmTyping = "tm_typing"
    case tmSelectHosts = "tm_select_hosts"
    case tmNoSavedHosts = "tm_no_saved_hosts"
    case tmOptions = "tm_options"
    case tmShareWarning = "tm_share_warning"
    case tmShareToGuests = "tm_share_to_guests"
    case tmShareHosts = "tm_share_hosts"
    case tmEnterPin = "tm_enter_pin"
    case tmPinForHost = "tm_pin_for_host"
    case tmPinGeneric = "tm_pin_generic"
    case tmPeople = "tm_people"
    case tmNoTerminalWarning = "tm_no_terminal_warning"
    case tmOpenTerminalFirst = "tm_open_terminal_first"
    case tmOpenLiveTerminal = "tm_open_live_terminal"
    case tmPairTimeout = "tm_pair_timeout"
    case tmGuestLeft = "tm_guest_left"
    case tmGuestLimit = "tm_guest_limit"
    case tmTooManyAttempts = "tm_too_many_attempts"
    case tmWrongPin = "tm_wrong_pin"
    case tmNoSharedTerminalNotice = "tm_no_shared_terminal_notice"
    case tmServiceStartFailed = "tm_service_start_failed"
    ...
    case sshRsa4096Desc = "ssh_rsa4096_desc"
    case sshEcdsaP256Desc = "ssh_ecdsa_p256_desc"
    case sshEcdsaP384Desc = "ssh_ecdsa_p384_desc"
    case sshPtyError = "ssh_pty_error"
    case sshPtyAdviceExhausted = "ssh_pty_advice_exhausted"
    case sshPtyAdviceRetry = "ssh_pty_advice_retry"
}
